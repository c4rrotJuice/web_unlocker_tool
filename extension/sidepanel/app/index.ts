...
import { CITATION_FORMATS, CITATION_STYLES, getCitationPreviewText, normalizeCitationFormat, normalizeCitationStyle } from "../../shared/types/citation.ts";
...
function describeNoteLinkingContext(pageContext: any = null) {
  if (pageContext?.pageUrl) {
...
export function createSidepanelShell(options: any = {}) {
  ...
  function showCitationPreview(citation, row, options: any = {}) {
    if (!citation?.id) {
      return;
    }

...
export function createActionButtonRow({
  ...
  openEditorButton.addEventListener("click", (event: any) => {
    event.preventDefault?.();
    void onOpenEditor?.();
  });
  dashboardButton.addEventListener("click", (event: any) => {
    event.preventDefault?.();
    void onOpenDashboard?.();
  });
  authButton.addEventListener("click", (event: any) => {
    event.preventDefault?.();

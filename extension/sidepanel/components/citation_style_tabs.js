...
import { CITATION_STYLES } from "../../shared/types/citation.js";
const STYLE_LABELS = {
    apa: "APA",
    mla: "MLA",
    chicago: "Chicago",
...
export function createCitationStyleTabs({ documentRef = globalThis.document, styles = CITATION_STYLES, selectedStyle = "apa", lockedStyles = [], lockLabel = "Locked", onSelect, } = {}) {

...
async function resolveActiveTabContext(chromeApi: any) {
...
function describePageContext(pageContext: any) {
...
export function renderSidepanel(root, options = {}) {
  ...
  authActions.append(
    createButton(documentRef, "Sign in", async () => {

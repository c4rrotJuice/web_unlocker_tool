import { createContentBridge } from "../messaging/bridge.ts";
import { extractNormalizedSelection, selectionSignature } from "../dom/selection.ts";
import { extractPageMetadata } from "../dom/page_metadata.ts";
import { buildCaptureIntentPayload, buildSelectionCapturePayload } from "../serializers/capture_payload.ts";
import { copyTextToClipboard } from "../utils/clipboard.ts";
import { createHighlightPill } from "../ui/highlight_pill.ts";
import { probePageContext } from "../dom/context_probe.ts";
import { buildWorkInEditorPayload } from "../../shared/types/work_in_editor.ts";
import { getActionAvailability, normalizeCapabilitySurface } from "../../shared/types/capability_surface.ts";
